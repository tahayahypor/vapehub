...
Revision ID: 7e1586fc37aa
Revises: 
Create Date: 2026-06-23 00:16:27.203226
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('PENDING', 'CONFIRMED', 'SHIPPED', 'CANCELLED', name='orderstatus'), nullable=False),
    sa.Column('full_name', sa.String(length=120), nullable=False),
